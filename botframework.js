! function(t, e) {
    ...
    return function(t) {
        ...
        var C = Object.prototype.hasOwnProperty,
            ...
            P = /[.?*+^$[\]\\(){}|-]/g,
            I = n(86);
        e.lib = {}, e.lib.mdurl = n(105), e.lib.ucmicro = n(446), e.assign = s, e.isString = o, e.has = i, e.unescapeMd = p, e.unescapeAll = h, e.isValidEntityCode = c, e.fromCodePoint = u, e.escapeHtml = d, e.arrayReplaceAt = a, e.isSpace = v, e.isWhiteSpace = g, e.isMdAsciiPunct = b, e.isPunctChar = y, e.escapeRE = m, e.normalizeReference = _
    }, function(t, e, n) {
        "use strict";
        var r = n(10),
            o = r;
        ...
        ***************************************************************************** */
            ...
            v = function(t) {
                function e(e) {
                    ...
                    return n.store = c.createStore(), n.resizeListener = function() {
                        return n.setSize()
                    }, n._handleCardAction = n.handleCardAction.bind(n), n._handleKeyDownCapture = n.handleKeyDownCapture.bind(n), n._saveChatviewPanelRef = n.saveChatviewPanelRef.bind(n), n._saveHistoryRef = n.saveHistoryRef.bind(n), n._saveShellRef = n.saveShellRef.bind(n), p.log("BotChat.Chat props", e), n.store.dispatch({
                        type: "Set_Locale",
        ...
        var a = new Error("expired token"),
            ...
            p = function() {
                ...
                return t.prototype.checkConnection = function(t) {
                	...
                	console.log("Peticion de Empezar conversacion")
        ...
        var r = n(11),
            ...
            u = function(t) {
                ...
                return r.__extends(e, t), e.prototype.sendMessage = function() {
                    ...
                    "Enter" !== t.key && " " !== t.key || (t.preventDefault(), this.sendMessage(), this.textInput.focus())
                    ...
                    this.props.sendFiles(this.fileInput.files), this.fileInput.value = null, this.textInput.focus()
        ...
        e.defaultStrings = r["en-us"], e.strings = function(t) {
            return t.startsWith("da") ? t = "da-dk" : t.startsWith("de") ? t = "de-de" : t.startsWith("no") || t.startsWith("nb") || t.startsWith("nn") ? t = "nb-no" : t.startsWith("pl") ? t = "pl-pl" : t.startsWith("ru") ? t = "ru-ru" : t.startsWith("nl") ? t = "nl-nl" : t.startsWith("lv") ? t = "lv-lv" : t.startsWith("pt") ? t = "pt-br" : t.startsWith("fr") ? t = "fr-fr" : t.startsWith("es") ? t = "es-es" : t.startsWith("el") ? t = "el-gr" : t.startsWith("it") ? t = "it-it" : "zh-hant" === t || "zh-hk" === t || "zh-mo" === t || "zh-tw" === t ? t = "zh-hant" : t.startsWith("zh") ? t = "zh-hans" : t.startsWith("cs") ? t = "cs-cz" : t.startsWith("ko") ? t = "ko-kr" : t.startsWith("ja") ? t = "ja-jp" : t in r == !1 && (t = "en-us"), r[t]
        }
    }, function(t, e, n) {
        "use strict";
        ...
        function s(t) {
            null != K.onExecuteAction && (t.prepare(t.parent.getRootElement().getAllInputs()), K.onExecuteAction(t))
        }
        ...
        t.exports = function(t, e) {
            ...
            function h(t) {
                function e(e, n, r, o, i, s) {
                    var a = e[n];
                    if (w(a) !== t) return new l("Invalid " + o + " `" + i + "` of type `" + x(a) + "` supplied to `" + r + "`, expected `" + t + "`.");
                    return null
                }
                return p(e)
            }
            ...
            function b(t) {
                function e(e, n, r, o, i) {
                    ...
                    for (var h in p) {
                        var f = t[h];
                        if (!f) return new l("Invalid " + o + " `" + i + "` key `" + h + "` supplied to `" + r + "`.\nBad object: " + JSON.stringify(e[n], null, "  ") + "\nValid keys: " + JSON.stringify(Object.keys(t), null, "  "));
        ...
        var b = function(t) {
            ...
            return p(e, t), e.prototype.next = function(t) {
                ...
                if (p === d.errorObject) this.error(d.errorObject.e);
                    ...
                    if (s && (p.timeout = e.timeout, p.responseType = e.responseType), "withCredentials" in p && (p.withCredentials = !!e.withCredentials), this.setHeaders(p, c), (u ? f.tryCatch(p.send).call(p, u) : f.tryCatch(p.send).call(p)) === d.errorObject) return this.error(d.errorObject.e), null
                }
                return p
        ...
        "use strict";
        e.Any = n(171), e.Cc = n(169), e.Cf = n(445), e.P = n(86), e.Z = n(170)
    }])
});